...
export default function ConfirmModal({
  ...
  useEffect(() => {
    if (!isOpen || !portalNode) return undefined;
    const previousOverflow = portalNode.style.overflow;
    portalNode.style.overflow = "hidden";
    ...
    return () => {
      ...
      portalNode.style.overflow = previousOverflow;
    };
  }, [isOpen, onCancel, onConfirm, portalNode]);
